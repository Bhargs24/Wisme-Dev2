  ...
  void _submitComparison() async {
    ...
    try {
      ...
      final comparisonData = {
        ...
        'effectivenessComparison': _effectivenessComparison,
        'engagementComparison': _engagementComparison,
        'futurePreference': _futurePreference,
        'conversationalRatings': _conversationalRatings,
        'traditionalRatings': _traditionalRatings,
        'openFeedback': _comparisonFeedback,
        'userProfile': research.userProfile,
      };

      await FirebaseService.submitFeedback({
        'type': 'journey_comparison',
        'data': comparisonData,
      });
