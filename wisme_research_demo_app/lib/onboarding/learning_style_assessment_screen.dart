...
class _LearningStyleAssessmentScreenState extends State<LearningStyleAssessmentScreen> {
  final Map<String, int> _currentLearningMethods = {
    'Reading articles/books': 0,
    'Watching video tutorials': 0,
    'Taking online courses': 0,
    'Hands-on practice': 0,
    'Group discussions': 0,
  ...
  bool _isAssessmentComplete() {
    return _currentLearningMethods.values.every((v) => v > 0) && _sessionDuration != null && _learningChallenges.isNotEmpty;
  }
        ...
        child: Column(
          children: [
            ...
            Align(
              ...
              child: Text('How do you typically learn new topics?', style: AppTextStyles.heading2.copyWith(fontSize: 18)),
            ),
            const SizedBox(height: 8),
            ..._currentLearningMethods.keys.map((method) => Row(
              children: [
            ...
            const SizedBox(height: 32),
            ElevatedButton(
              onPressed: _isAssessmentComplete() ? () => Navigator.pushNamed(context, '/baseline_knowledge') : null,
