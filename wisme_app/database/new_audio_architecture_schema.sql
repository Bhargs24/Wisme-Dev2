...
-- Insert comprehensive speaker voices for all 15 categories with optimized pairs
INSERT OR REPLACE INTO speaker_voices VALUES
  -- 1. Technology & AI Category
  ...
  -- 3. Psychology & Mind Category
  ('host_kai_psychology', 'Kai', 'host', 'psychology', 'ElevenLabsVoiceID1',
   '["empathetic", "curious", "supportive"]',
   '{"pace": "moderate", "energy": "warm", "formality": "conversational"}',
   '["human behavior", "mental health", "cognitive science"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_sara_psychology', 'Sara', 'expert', 'psychology', 'ElevenLabsVoiceID5',
   '["compassionate", "insightful", "scientific"]',
   '{"pace": "calm", "energy": "moderate", "formality": "professional"}',
   '["behavioral psychology", "therapy", "neuroscience"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 4. Science & Nature Category
  ('host_maya_science', 'Maya', 'host', 'science', 'ElevenLabsVoiceID3',
   '["wonder-filled", "questioning", "enthusiastic"]',
   '{"pace": "animated", "energy": "high", "formality": "casual"}',
   '["natural sciences", "discoveries", "research"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_alex_science', 'Alex', 'expert', 'science', 'ElevenLabsVoiceID2',
   '["methodical", "precise", "educational"]',
   '{"pace": "clear", "energy": "moderate", "formality": "academic"}',
   '["physics", "biology", "chemistry", "research methods"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 5. Creativity & Design Category
  ('host_zoe_creative', 'Zoe', 'host', 'creativity', 'ElevenLabsVoiceID6',
   '["inspiring", "artistic", "expressive"]',
   '{"pace": "varied", "energy": "creative", "formality": "relaxed"}',
   '["design thinking", "creative process", "visual arts"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_sara_creative', 'Sara', 'expert', 'creativity', 'ElevenLabsVoiceID5',
   '["innovative", "detailed", "passionate"]',
   '{"pace": "thoughtful", "energy": "passionate", "formality": "artistic"}',
   '["design principles", "creative techniques", "artistic history"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 6. Self-Growth Category
  ('host_kai_growth', 'Kai', 'host', 'self_growth', 'ElevenLabsVoiceID1',
   '["motivational", "relatable", "encouraging"]',
   '{"pace": "steady", "energy": "positive", "formality": "friendly"}',
   '["personal development", "habits", "mindset"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_david_growth', 'David', 'expert', 'self_growth', 'ElevenLabsVoiceID4',
   '["wise", "practical", "goal-oriented"]',
   '{"pace": "deliberate", "energy": "steady", "formality": "mentoring"}',
   '["productivity", "goal setting", "life strategy"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 7. History & Culture Category
  ('host_zoe_history', 'Zoe', 'host', 'history', 'ElevenLabsVoiceID6',
   '["storytelling", "curious", "dramatic"]',
   '{"pace": "narrative", "energy": "engaging", "formality": "storytelling"}',
   '["historical events", "cultural analysis", "storytelling"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_alex_history', 'Alex', 'expert', 'history', 'ElevenLabsVoiceID2',
   '["scholarly", "contextual", "analytical"]',
   '{"pace": "informative", "energy": "moderate", "formality": "academic"}',
   '["historical analysis", "cultural studies", "research"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 8. Skills & Tools Category
  ('host_maya_skills', 'Maya', 'host', 'skills', 'ElevenLabsVoiceID3',
   '["hands-on", "practical", "action-oriented"]',
   '{"pace": "instructional", "energy": "focused", "formality": "tutorial"}',
   '["practical skills", "tool mastery", "workflows"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_david_skills', 'David', 'expert', 'skills', 'ElevenLabsVoiceID4',
   '["technical", "systematic", "efficient"]',
   '{"pace": "step-by-step", "energy": "focused", "formality": "instructional"}',
   '["advanced techniques", "productivity tools", "systems"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 9. Career & Strategy Category
  ('host_maya_career', 'Maya', 'host', 'career', 'ElevenLabsVoiceID3',
   '["ambitious", "strategic", "supportive"]',
   '{"pace": "confident", "energy": "motivating", "formality": "professional"}',
   '["career development", "professional growth", "networking"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_david_career', 'David', 'expert', 'career', 'ElevenLabsVoiceID4',
   '["strategic", "experienced", "mentor-like"]',
   '{"pace": "advisory", "energy": "steady", "formality": "executive"}',
   '["leadership", "career strategy", "professional development"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 10. Law & Governance Category
  ('host_kai_law', 'Kai', 'host', 'law', 'ElevenLabsVoiceID1',
   '["inquisitive", "clear", "accessible"]',
   '{"pace": "careful", "energy": "measured", "formality": "legal_casual"}',
   '["legal concepts", "governance", "civic education"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_david_law', 'David', 'expert', 'law', 'ElevenLabsVoiceID4',
   '["authoritative", "precise", "educational"]',
   '{"pace": "deliberate", "energy": "serious", "formality": "legal_professional"}',
   '["legal analysis", "constitutional law", "policy"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 11. Geopolitics & Global Affairs Category
  ('host_zoe_geopolitics', 'Zoe', 'host', 'geopolitics', 'ElevenLabsVoiceID6',
   '["worldly", "analytical", "engaging"]',
   '{"pace": "journalistic", "energy": "informed", "formality": "news_casual"}',
   '["international relations", "current events", "global trends"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_alex_geopolitics', 'Alex', 'expert', 'geopolitics', 'ElevenLabsVoiceID2',
   '["diplomatic", "analytical", "contextual"]',
   '{"pace": "informative", "energy": "serious", "formality": "academic"}',
   '["international relations", "diplomacy", "global analysis"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 12. Environment & Sustainability Category
  ('host_maya_environment', 'Maya', 'host', 'environment', 'ElevenLabsVoiceID3',
   '["passionate", "concerned", "hopeful"]',
   '{"pace": "urgent", "energy": "committed", "formality": "activist_professional"}',
   '["climate change", "sustainability", "environmental action"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_alex_environment', 'Alex', 'expert', 'environment', 'ElevenLabsVoiceID2',
   '["scientific", "solution-focused", "factual"]',
   '{"pace": "evidence-based", "energy": "steady", "formality": "scientific"}',
   '["environmental science", "climate research", "green technology"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 13. Mathematics & Logic Category
  ('host_kai_math', 'Kai', 'host', 'mathematics', 'ElevenLabsVoiceID1',
   '["logical", "patient", "encouraging"]',
   '{"pace": "step-by-step", "energy": "supportive", "formality": "educational"}',
   '["mathematical concepts", "logical reasoning", "problem solving"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_alex_math', 'Alex', 'expert', 'mathematics', 'ElevenLabsVoiceID2',
   '["precise", "methodical", "clear"]',
   '{"pace": "systematic", "energy": "focused", "formality": "academic"}',
   '["advanced mathematics", "logic systems", "mathematical proof"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 14. Gaming & Interactive Media Category
  ('host_zoe_gaming', 'Zoe', 'host', 'gaming', 'ElevenLabsVoiceID6',
   '["enthusiastic", "relatable", "fun"]',
   '{"pace": "energetic", "energy": "playful", "formality": "gaming_casual"}',
   '["game design", "gaming culture", "interactive media"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_sara_gaming', 'Sara', 'expert', 'gaming', 'ElevenLabsVoiceID5',
   '["technical", "creative", "industry-savvy"]',
   '{"pace": "informative", "energy": "excited", "formality": "industry"}',
   '["game development", "design principles", "interactive storytelling"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  -- 15. Society & Ethics Category
  ('host_kai_society', 'Kai', 'host', 'society', 'ElevenLabsVoiceID1',
   '["thoughtful", "questioning", "balanced"]',
   '{"pace": "reflective", "energy": "contemplative", "formality": "philosophical"}',
   '["social structures", "ethical frameworks", "moral philosophy"]', NULL, CURRENT_TIMESTAMP, TRUE, 0),

  ('expert_sara_society', 'Sara', 'expert', 'society', 'ElevenLabsVoiceID5',
   '["philosophical", "analytical", "ethical"]',
   '{"pace": "thoughtful", "energy": "serious", "formality": "academic"}',
   '["social theory", "ethics", "moral philosophy", "social justice"]', NULL, CURRENT_TIMESTAMP, TRUE, 0);
