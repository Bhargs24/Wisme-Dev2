  ...
  List<Episode> _createMockJourney() {
    return [
      ...
      Episode(
        ...
        category: widget.category ?? '💻 Technology & AI',
        knowledgeLevel: '🎛 Bit of Everything',
        coachPersonality: 'Kai',
        hashtags: [widget.topic.toLowerCase().replaceAll(' ', '_')],
        durationMinutes: 10,
        createdAt: DateTime.now(),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          ...
          'Each journey is crafted by AI to match your goals and interests, with our coaches Kai and Vee guiding you through the experience.',
        ),
        actions: [
          TextButton(
